...
def main(args):
    ...
    if args.do_unlearning:
        ...
        gear_kwargs = dict(
            ...
            forget_forget_mode=args.forget_forget_mode,
            retain_entanglement_protection=args.retain_entanglement_protection,
            retain_protection_strength=args.retain_protection_strength,
